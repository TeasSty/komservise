  ...
  return (
    <section className="hero" id="top" aria-labelledby="hero-title">
      ...
      <div className="wrap hero-content">
        ...
        <h1 id="hero-title">
          Узаконивание переделок и регистрация в ГИБДД под ключ
        </h1>
        <p className="hero-lead">
          Внедорожный тюнинг, ГБО, SWAP, фаркопы, переоборудование — оформим
          документы через лабораторию и ГИБДД. Плюс ремонт ДВС, ходовой и
          электрики в Саратове.
        </p>
